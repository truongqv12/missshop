...
class AuthTokenGenerator
{
    ...
    /**
     * Create the token for database.php login
     *
     * @param string $endpoint The database.php hostname with port number specified
     *                         (e.g., host:port)
     * @param string $region The region where the database.php is located
