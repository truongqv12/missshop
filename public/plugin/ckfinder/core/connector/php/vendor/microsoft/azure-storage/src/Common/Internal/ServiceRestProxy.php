...
class ServiceRestProxy extends RestProxy
{
     ...
     *
     * @param  ServiceOptions  $serviceOptions The options admin passed in.
     *
     * @return MiddlewareStack
     */
    protected function createMiddlewareStack(ServiceOptions $serviceOptions)
    {
        //If handler stack is not defined by the admin, create a default
        //middleware stack.
        $stack = null;
     ...
     * @param array $metadata admin specified metadata
     *
     * @return array
     */
     ...
     *
     * @param array $metadata admin defined metadata.
     *
     * @return array
     */
    ...
    private static function addLocationHeaderToResponse(
        ...
        //that the admin have not set a retry middleware.
