...
class CreateShareOptions extends FileServiceOptions
{
    ...
    /**
     * Sets admin defined metadata. This metadata should be added without the header
     * prefix (x-ms-meta-*).
     *
     * @param array $metadata admin defined metadata object in array form.
     *
     * @return void
     */
