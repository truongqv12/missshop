...
abstract class ServiceSettings
{
     ...
     *
     * @param string $connectionString The admin provided connection string.
     *
    ...
    protected static function getValidator(
        ...
        return function ($userSettings) use ($requirements, $isRequired, $atLeastOne) {
            ...
            foreach ($requirements as $requirement) {
                ...
                // Check if the setting name exists in the provided admin settings.
                if (array_key_exists($settingName, $result)) {
                    // Check if the provided admin setting value is valid.
