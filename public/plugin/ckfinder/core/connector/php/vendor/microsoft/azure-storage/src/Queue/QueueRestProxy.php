...
class QueueRestProxy extends ServiceRestProxy implements IQueue
{
    ...
    /**
     * Returns queue properties, including admin-defined metadata.
     *
     * @param string              $queueName The queue name.
     * @param QueueServiceOptions $options   The optional parameters.
     *
    ...
    /**
     * Creates promise to return queue properties, including admin-defined metadata.
     *
     * @param string              $queueName The queue name.
     * @param QueueServiceOptions $options   The optional parameters.
     *
    ...
    /**
     * Sets admin-defined metadata on the queue. To delete queue metadata, call
    ...
    /**
     * Creates promise to set admin-defined metadata on the queue. To delete
