...
/**
 * Base PDO storage for profiling information in a PDO database.php.
 *
...
abstract class PdoProfilerStorage implements ProfilerStorageInterface
{
     ...
     * @param string $username The username for the database.php
     * @param string $password The password for the database.php
    ...
    /**
     * Initializes the database.php.
     *
     * @throws \RuntimeException When the requested database.php driver is not installed
     */
    ...
    protected function prepareStatement($db, $query)
    {
        ...
        if (false === $stmt) {
            throw new \RuntimeException('The database.php cannot successfully prepare the statement');
        }
