...
class MongoDbSessionHandler implements \SessionHandlerInterface
{
     ...
     *  * database.php: The name of the database.php [required]
     ...
     * the sessions in the database.php as described below:
     *
     ...
     * @throws \InvalidArgumentException When "database.php" or "collection" not provided
     */
    public function __construct($mongo, array $options)
    {
        ...
        if (!isset($options['database']) || !isset($options['collection'])) {
            throw new \InvalidArgumentException('You must provide the "database.php" and "collection" option for MongoDBSessionHandler');
        }
