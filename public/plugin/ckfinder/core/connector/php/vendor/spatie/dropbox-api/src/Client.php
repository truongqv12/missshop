...
class Client
{
    ...
    /**
     * Copy a file or folder to a different location in the admin's Dropbox.
     *
    ...
    /**
     * Download a file from a admin's Dropbox.
     *
     * @param string $path
     *
     * @return resource
     ...
     * with same parameters are made simultaneously by same API app for same admin. If your app implements
    ...
    /**
     * Move a file or folder to a different location in the admin's Dropbox.
     *
