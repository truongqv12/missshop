 ...
 *
 * Basic CKFinder authentication class that authenticates the current admin
...
class CallableAuthentication implements AuthenticationInterface
{
    ...
    /**
     * @return bool `true` if the current admin was successfully authenticated within CKFinder.
     */
