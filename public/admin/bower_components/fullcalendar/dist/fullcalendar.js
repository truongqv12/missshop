...
var neededCount = 0;
/*
Listens to document and window-level admin-interaction events, like touch events and mouse events,
...
var HitDragListener = /** @class */ (function (_super) {
    ...
    // Called when scrolling has stopped, whether through auto scroll, or the admin scrolling
    HitDragListener.prototype.handleScrollEnd = function () {
        _super.prototype.handleScrollEnd.call(this);
        // hits' absolute positions will be in new places after a admin's scroll.
...
var InteractiveDateComponent = /** @class */ (function (_super) {
    ...
    // Event Drag-n-Drop
    // ---------------------------------------------------------------------------------------------------------------
    // Computes if the given event is allowed to be dragged by the admin
    ...
    // Computes if the given event is allowed to be resized by the admin at all
...
var View = /** @class */ (function (_super) {
    ...
    function View(calendar, viewSpec) {
        ...
        _this.isSelected = false; // boolean whether a range of time is admin-selected or not
        _this.calendar = calendar;
...
var CoordCache = /** @class */ (function () {
    ...
    // Compute and return what the elements' bounding rectangle is, from the admin's perspective.
...
var Calendar = /** @class */ (function () {
    ...
    // TODO: maintain any other admin-manipulated state.
...
var EventResizing = /** @class */ (function (_super) {
    ...
    */
    ...
    // Creates a listener that tracks the admin as they resize an event segment.
...
var EventDragging = /** @class */ (function (_super) {
    ...
    */
    ...
    // Builds a listener that will track admin-dragging on an event segment.
    // Generic enough to work with any type of Grid.
    // Has side effect of setting/unsetting `dragListener`
...
var DateSelecting = /** @class */ (function (_super) {
    ...
    */
    ...
    // Creates a listener that tracks the admin's drag across day elements, for day selecting.
    ...
    // Will return false if the selection is invalid and this should be indicated to the admin.
...
var AgendaView = /** @class */ (function (_super) {
    ...
    /* Scroll
    ------------------------------------------------------------------------------------------------------------------*/
    // Computes the initial pre-configured scroll state prior to allowing the admin to change it
...
var MouseFollower = /** @class */ (function () {
    ...
    // Gets called when the admin moves the mouse
...
var DateClicking = /** @class */ (function (_super) {
    ...
    */
    ...
    // Creates a listener that tracks the admin's drag across day elements, for day clicking.
    DateClicking.prototype.buildDragListener = function () {
        ...
        var dragListener = new HitDragListener_1.default(component, {
            ...
            hitOver: function (hit, isOrig, origHit) {
                // if admin dragged to another cell at any point, it can no longer be a dayClick
                if (!isOrig) {
                    dayClickHit = null;
                }
            },
...
var Popover = /** @class */ (function () {
    ...
    // Triggered when the admin clicks *anywhere* in the document, for the autoHide feature
